              ...
              <div className="space-y-3" style={{ color: '#00ff00' }}>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm" style={{ color: 'rgba(0, 255, 0, 0.8)' }}>cybersec@stonybrook.edu</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <span style={{ color: '#00ffff' }}>💬</span>
                  <div>
                    ...
                    <div className="text-sm" style={{ color: 'rgba(0, 255, 0, 0.8)' }}>discord.gg/sbucybersec</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <span style={{ color: '#00ffff' }}>📍</span>
          ...
          <ScrollReveal delay={150}>
            <GlowCard glowColor="255, 0, 255">
              ...
              <div className="space-y-2" style={{ color: '#00ff00' }}>
                <a href="#" className="flex items-center space-x-2 transition-all hover:translate-x-2" style={{ color: '#00ff00' }}>
                  <span>🐦</span>
                  <span className="hover:text-terminal-cyan">Twitter: @SBUCyberSec</span>
                </a>
                <a href="#" className="flex items-center space-x-2 transition-all hover:translate-x-2" style={{ color: '#00ff00' }}>
                  <span>📸</span>
                  <span className="hover:text-terminal-cyan">Instagram: @sbu_cybersec</span>
                </a>
                <a href="#" className="flex items-center space-x-2 transition-all hover:translate-x-2" style={{ color: '#00ff00' }}>
                  <span>💼</span>
                  <span className="hover:text-terminal-cyan">LinkedIn: SBU Cybersecurity Club</span>
                </a>
                <a href="#" className="flex items-center space-x-2 transition-all hover:translate-x-2" style={{ color: '#00ff00' }}>
                  <span>🐙</span>
                  <span className="hover:text-terminal-cyan">GitHub: sbu-cybersec</span>
                </a>
              </div>
            </GlowCard>
          </ScrollReveal>
